        ...
        .map((teaching) => {
          ...
          const deleteBtn =
            teaching.username === localStorage.getItem("username")
              ? `
            <svg width="25" height="25" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class='delete'>
          ...
          const editBtn =
            teaching.username === localStorage.getItem("username")
              ? `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class='edit-btn' xmlns="http://www.w3.org/2000/svg">
